...
radio_opt=["Use SQLLite 3 Database- inventory.db","Connect to you MySQL Database"]
...
def chunk_text(text, chunk_size=5000):
    """Splits text into smaller chunks within Groq’s token limit."""
...
def configure_db(db_uri,mysql_host=None,mysql_user=None,mysql_password=None,mysql_db=None):
    if db_uri==LOCALDB:
        dbfilepath=(Path(__file__).parent/"inventory.db").absolute()
        print(dbfilepath)
